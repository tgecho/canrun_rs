use crate::{constrain_2, Can, CanT, Goal, LVar};

pub fn greater_than<'a, T: CanT + PartialOrd + 'a>(a: Can<T>, b: Can<T>) -> Goal<'a, T> {
    constrain_2(a, b, |a, b| a > b)
}
pub fn less_than<'a, T: CanT + PartialOrd + 'a>(a: Can<T>, b: Can<T>) -> Goal<'a, T> {
    constrain_2(a, b, |a, b| a < b)
}
...
impl<'a, T: CanT + PartialOrd + 'a> RelativeComparison<'a, T> for Can<T> {
    fn greater_than(self, other: Can<T>) -> Goal<'a, T> {
...
impl<'a, T: CanT + PartialOrd + 'a> RelativeComparison<'a, T> for LVar {
    fn greater_than(self, other: Can<T>) -> Goal<'a, T> {
